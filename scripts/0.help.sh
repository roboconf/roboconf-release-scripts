...
echo
echo "1. Create/update 'conf.bintray.sh', 'conf.dockerhub.sh' and edit 'conf.sh' with your settings."
echo "2. Update and tag roboconf-web-administration."
echo "3. Release roboconf-platform."
echo "   Be careful, there are 2 scripts: one for « normal » releases and one for « maintenance » releases."
echo
echo "   Wait for the platform to be available on Maven Central."
echo
...
echo "9. Update, tag and upload Docker images for Roboconf."
echo
